  ...
  return (
    <div className="login">
      <Modal
        ...
        primaryButtonText={t(
          `content.login.${isNewUser ? 'signupPrimary' : 'loginPrimary'}`
        )}
        secondaryButtonText={t(
          `content.login.${isNewUser ? 'signupSecondary' : 'loginSecondary'}`
        )}
        modalLabel={t('content.login.title')}
        modalHeading={t(
          `content.login.${isNewUser ? 'signupTitle' : 'loginTitle'}`
        )}
